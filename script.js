...
//we create a function and write locomotive code in this function to make code easy to understandable
...
//here we call the function it is neccecery

loco();

//we create a code for page 2 animation
...
//gsap animation we use in this code 
...
function canvas() {
    ...
    function files(index) {
        var data = `./assets/frames00007.png
...
//call the canvas function we just made a function
canvas()
...
function canvas3() {
    const canvas = document.querySelector("#right>canvas");
    const context = canvas.getContext("2d");
